...
{
public:
	class UGameAICommand*                              CommandList;                                      		// 0x03C4 (0x0004) [0x0000000000002002]              ( CPF_Const | CPF_Transient )
	unsigned long                                      bHasRunawayCommandList : 1;                       		// 0x03C8 (0x0004) [0x0000000000002000] [0x00000001] ( CPF_Transient )
	unsigned long                                      bAILogging : 1;                                   		// 0x03C8 (0x0004) [0x0000000000004001] [0x00000002] ( CPF_Edit | CPF_Config )
	unsigned long                                      bAILogToWindow : 1;                               		// 0x03C8 (0x0004) [0x0000000000004001] [0x00000004] ( CPF_Edit | CPF_Config )
	unsigned long                                      bFlushAILogEachLine : 1;                          		// 0x03C8 (0x0004) [0x0000000000004001] [0x00000008] ( CPF_Edit | CPF_Config )
	unsigned long                                      bMapBasedLogName : 1;                             		// 0x03C8 (0x0004) [0x0000000000004001] [0x00000010] ( CPF_Edit | CPF_Config )
	unsigned long                                      bAIDrawDebug : 1;                                 		// 0x03C8 (0x0004) [0x0000000000004001] [0x00000020] ( CPF_Edit | CPF_Config )
	unsigned long                                      bAIBroken : 1;                                    		// 0x03C8 (0x0004) [0x0000000000002000] [0x00000040] ( CPF_Transient )
	class AFileLog*                                    AILogFile;                                        		// 0x03CC (0x0004) [0x0000000000002000]              ( CPF_Transient )
	TArray< struct FName >                             AILogFilter;                                      		// 0x03D0 (0x000C) [0x0000000000404001]              ( CPF_Edit | CPF_Config | CPF_NeedCtorLink )
	struct FString                                     DemoActionString;                                 		// 0x03DC (0x000C) [0x0000000000400020]              ( CPF_Net | CPF_NeedCtorLink )
...
// 0x01DC (0x03F0 - 0x0214)
class AGameCrowdAgent : public ACrowdAgentBase
{
public:
	class UGameCrowdGroup*                             MyGroup;                                          		// 0x0214 (0x0004) [0x0000000000000000]              
	struct FVector                                     PreferredVelocity;                                		// 0x0218 (0x000C) [0x0000000000000000]              
	float                                              AvoidanceShare;                                   		// 0x0224 (0x0004) [0x0000000000000000]              
	class AGameCrowdDestination*                       CurrentDestination;                               		// 0x0228 (0x0004) [0x0000000000000000]              
	class AGameCrowdDestination*                       BehaviorDestination;                              		// 0x022C (0x0004) [0x0000000000000000]              
	class AGameCrowdDestination*                       PreviousDestination;                              		// 0x0230 (0x0004) [0x0000000000000000]              
	struct FVector                                     ExternalForce;                                    		// 0x0234 (0x000C) [0x0000000000000000]              
	...
	int                                                AwareUpdateFrameCount;                            		// 0x0254 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	TArray< class AActor* >                            NearbyDynamics;                                   		// 0x0258 (0x000C) [0x0000000000402000]              ( CPF_Transient | CPF_NeedCtorLink )
	TArray< class AGameCrowdForcePoint* >              RelevantAttractors;                               		// 0x0264 (0x000C) [0x0000000000402000]              ( CPF_Transient | CPF_NeedCtorLink )
	unsigned long                                      bUniformScale : 1;                                		// 0x0270 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bCheckForObstacles : 1;                           		// 0x0270 (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned long                                      bUseNavMeshPathing : 1;                           		// 0x0270 (0x0004) [0x0000000000000001] [0x00000004] ( CPF_Edit )
	unsigned long                                      bWantsSeePlayerNotification : 1;                  		// 0x0270 (0x0004) [0x0000000000000000] [0x00000008] 
	unsigned long                                      bAllowPitching : 1;                               		// 0x0270 (0x0004) [0x0000000000000001] [0x00000010] ( CPF_Edit )
	unsigned long                                      bHitObstacle : 1;                                 		// 0x0270 (0x0004) [0x0000000000000000] [0x00000020] 
	unsigned long                                      bBadHitNormal : 1;                                		// 0x0270 (0x0004) [0x0000000000000000] [0x00000040] 
	unsigned long                                      bSimulateThisTick : 1;                            		// 0x0270 (0x0004) [0x0000000000000000] [0x00000080] 
	unsigned long                                      bClampMovementSpeed : 1;                          		// 0x0270 (0x0004) [0x0000000000000001] [0x00000100] ( CPF_Edit )
	unsigned long                                      bPotentialEncounter : 1;                          		// 0x0270 (0x0004) [0x0000000000000000] [0x00000200] 
	unsigned long                                      bIsPanicked : 1;                                  		// 0x0270 (0x0004) [0x0000000000000000] [0x00000400] 
	unsigned long                                      bWantsGroupIdle : 1;                              		// 0x0270 (0x0004) [0x0000000000000000] [0x00000800] 
	unsigned long                                      bPreferVisibleDestination : 1;                    		// 0x0270 (0x0004) [0x0000000000000001] [0x00001000] ( CPF_Edit )
	unsigned long                                      bPreferVisibleDestinationOnSpawn : 1;             		// 0x0270 (0x0004) [0x0000000000000001] [0x00002000] ( CPF_Edit )
	unsigned long                                      bHasNotifiedSpawner : 1;                          		// 0x0270 (0x0004) [0x0000000000000000] [0x00004000] 
	unsigned long                                      bIsInSpawnPool : 1;                               		// 0x0270 (0x0004) [0x0000000000000000] [0x00008000] 
	unsigned char                                      ConformType;                                      		// 0x0274 (0x0001) [0x0000000000000001]              ( CPF_Edit )
	float                                              ConformTraceDist;                                 		// 0x0278 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                ConformTraceInterval;                             		// 0x027C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                CurrentConformTraceInterval;                      		// 0x0280 (0x0004) [0x0000000000000000]              
	float                                              LastGroundZ;                                      		// 0x0284 (0x0004) [0x0000000000000000]              
	float                                              AwareRadius;                                      		// 0x0288 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                AwareUpdateInterval;                              		// 0x028C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	...
	float                                              AvoidOtherRadius;                                 		// 0x0298 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              GroupAttractionStrength;                          		// 0x029C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MatchVelStrength;                                 		// 0x02A0 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              FollowPathStrength;                               		// 0x02A4 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              VelocityDamping;                                  		// 0x02A8 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              RotateToTargetSpeed;                              		// 0x02AC (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MaxYawRate;                                       		// 0x02B0 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FVector                                     MeshMinScale3D;                                   		// 0x02B4 (0x000C) [0x0000000000000001]              ( CPF_Edit )
	struct FVector                                     MeshMaxScale3D;                                   		// 0x02C0 (0x000C) [0x0000000000000001]              ( CPF_Edit )
	float                                              EyeZOffset;                                       		// 0x02CC (0x0004) [0x0000000000000000]              
	float                                              ProximityLODDist;                                 		// 0x02D0 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              VisibleProximityLODDist;                          		// 0x02D4 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FVector                                     LastKnownGoodPosition;                            		// 0x02D8 (0x000C) [0x0000000000000000]              
	float                                              GroundOffset;                                     		// 0x02E4 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FVector                                     IntermediatePoint;                                		// 0x02E8 (0x000C) [0x0000000000000000]              
	struct FVector                                     SearchExtent;                                     		// 0x02F4 (0x000C) [0x0000000000000000]              
	class UClass*                                      NavigationHandleClass;                            		// 0x0300 (0x0004) [0x0000000000000000]              
	class UNavigationHandle*                           NavigationHandle;                                 		// 0x0304 (0x0004) [0x0000000000000000]              
	int                                                ObstacleCheckCount;                               		// 0x0308 (0x0004) [0x0000000000000000]              
	float                                              WalkableFloorZ;                                   		// 0x030C (0x0004) [0x0000000000000000]              
	float                                              LastPathingAttempt;                               		// 0x0310 (0x0004) [0x0000000000000000]              
	float                                              LastUpdateTime;                                   		// 0x0314 (0x0004) [0x0000000000000000]              
	float                                              NotVisibleLifeSpan;                               		// 0x0318 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              NotVisibleTickScalingFactor;                      		// 0x031C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	...
	TArray< struct FBehaviorEntry >                    EncounterAgentBehaviors;                          		// 0x036C (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< struct FBehaviorEntry >                    SeePlayerBehaviors;                               		// 0x0378 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	float                                              MaxSeePlayerDistSq;                               		// 0x0384 (0x0004) [0x0000000000000000]              
	float                                              SeePlayerInterval;                                		// 0x0388 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	TArray< struct FBehaviorEntry >                    SpawnBehaviors;                                   		// 0x038C (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< struct FBehaviorEntry >                    PanicBehaviors;                                   		// 0x0398 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< struct FBehaviorEntry >                    RandomBehaviors;                                  		// 0x03A4 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	float                                              RandomBehaviorInterval;                           		// 0x03B0 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              ForceUpdateTime;                                  		// 0x03B4 (0x0004) [0x0000000000000000]              
	float                                              ReachThreshold;                                   		// 0x03B8 (0x0004) [0x0000000000000000]              
	TArray< struct FBehaviorEntry >                    GroupWaitingBehaviors;                            		// 0x03BC (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	float                                              DesiredGroupRadius;                               		// 0x03C8 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              DesiredGroupRadiusSq;                             		// 0x03CC (0x0004) [0x0000000000000000]              
	float                                              MaxLOSLifeDistance;                               		// 0x03D0 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MaxLOSLifeDistanceSq;                             		// 0x03D4 (0x0004) [0x0000000000000000]              
	class UGameCrowdSpawnerInterface*                  MySpawner;                                        		// 0x03D8 (0x0008) [0x0000000000000000]              
	unsigned char                                      UnknownData00[ 0x4 ];                             		// 0x03DC (0x0004) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	struct FVector                                     SpawnOffset;                                      		// 0x03E0 (0x000C) [0x0000000000000000]              
	float                                              InitialLastRenderTime;                            		// 0x03EC (0x0004) [0x0000000000000000]              
...
{
public:
	class USkeletalMeshComponent*                      SkeletalMeshComponent;                            		// 0x03F0 (0x0004) [0x0000000004080009]              ( CPF_Edit | CPF_ExportObject | CPF_Component | CPF_EditInline )
	class UAnimNodeBlend*                              SpeedBlendNode;                                   		// 0x03F4 (0x0004) [0x0000000000000000]              
	class UAnimNodeSlot*                               FullBodySlot;                                     		// 0x03F8 (0x0004) [0x0000000000000000]              
	class UAnimNodeSequence*                           ActionSeqNode;                                    		// 0x03FC (0x0004) [0x0000000000000000]              
	class UAnimNodeSequence*                           WalkSeqNode;                                      		// 0x0400 (0x0004) [0x0000000000000000]              
	class UAnimNodeSequence*                           RunSeqNode;                                       		// 0x0404 (0x0004) [0x0000000000000000]              
	class UAnimTree*                                   AgentTree;                                        		// 0x0408 (0x0004) [0x0000000000000000]              
	TArray< struct FName >                             WalkAnimNames;                                    		// 0x040C (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< struct FName >                             RunAnimNames;                                     		// 0x0418 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< struct FName >                             IdleAnimNames;                                    		// 0x0424 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< struct FName >                             DeathAnimNames;                                   		// 0x0430 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	float                                              SpeedBlendStart;                                  		// 0x043C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              SpeedBlendEnd;                                    		// 0x0440 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              AnimVelRate;                                      		// 0x0444 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MaxSpeedBlendChangeSpeed;                         		// 0x0448 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FName                                       MoveSyncGroupName;                                		// 0x044C (0x0008) [0x0000000000000001]              ( CPF_Edit )
	TArray< struct FGameCrowdAttachmentList >          Attachments;                                      		// 0x0454 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	float                                              MaxTargetAcquireTime;                             		// 0x0460 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      bUseRootMotionVelocity : 1;                       		// 0x0464 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned long                                      bIsPlayingIdleAnimation : 1;                      		// 0x0464 (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned long                                      bIsPlayingDeathAnimation : 1;                     		// 0x0464 (0x0004) [0x0000000000000000] [0x00000004] 
	unsigned long                                      bAnimateThisTick : 1;                             		// 0x0464 (0x0004) [0x0000000000000000] [0x00000008] 
	float                                              MaxAnimationDistance;                             		// 0x0468 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MaxAnimationDistanceSq;                           		// 0x046C (0x0004) [0x0000000000000000]              
...
{
public:
	struct FPointer                                    VfTable_IInterface_NavigationHandle;              		// 0x0218 (0x0004) [0x0000000000801002]              ( CPF_Const | CPF_Native | CPF_NoExport )
	struct FPointer                                    VfTable_IEditorLinkSelectionInterface;            		// 0x021C (0x0004) [0x0000000000801002]              ( CPF_Const | CPF_Native | CPF_NoExport )
	unsigned long                                      bKillWhenReached : 1;                             		// 0x0220 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned long                                      bAllowAsPreviousDestination : 1;                  		// 0x0220 (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned long                                      bLastAllowableResult : 1;                         		// 0x0220 (0x0004) [0x0000000000000000] [0x00000004] 
	unsigned long                                      bAvoidWhenPanicked : 1;                           		// 0x0220 (0x0004) [0x0000000000000001] [0x00000008] ( CPF_Edit )
	unsigned long                                      bSkipBehaviorIfPanicked : 1;                      		// 0x0220 (0x0004) [0x0000000000000001] [0x00000010] ( CPF_Edit )
	unsigned long                                      bFleeDestination : 1;                             		// 0x0220 (0x0004) [0x0000000000000001] [0x00000020] ( CPF_Edit )
	unsigned long                                      bMustReachExactly : 1;                            		// 0x0220 (0x0004) [0x0000000000000001] [0x00000040] ( CPF_Edit )
	unsigned long                                      bHasRestrictions : 1;                             		// 0x0220 (0x0004) [0x0000000000000000] [0x00000080] 
	unsigned long                                      bAllowsSpawning : 1;                              		// 0x0220 (0x0004) [0x0000000000000001] [0x00000100] ( CPF_Edit )
	unsigned long                                      bLineSpawner : 1;                                 		// 0x0220 (0x0004) [0x0000000000000001] [0x00000200] ( CPF_Edit )
	unsigned long                                      bSpawnAtEdge : 1;                                 		// 0x0220 (0x0004) [0x0000000000000001] [0x00000400] ( CPF_Edit )
	unsigned long                                      bSoftPerimeter : 1;                               		// 0x0220 (0x0004) [0x0000000000000001] [0x00000800] ( CPF_Edit )
	unsigned long                                      bIsVisible : 1;                                   		// 0x0220 (0x0004) [0x0000000000000000] [0x00001000] 
	unsigned long                                      bWillBeVisible : 1;                               		// 0x0220 (0x0004) [0x0000000000000000] [0x00002000] 
	unsigned long                                      bCanSpawnHereNow : 1;                             		// 0x0220 (0x0004) [0x0000000000000000] [0x00004000] 
	unsigned long                                      bIsBeyondSpawnDistance : 1;                       		// 0x0220 (0x0004) [0x0000000000000000] [0x00008000] 
	unsigned long                                      bAdjacentToVisibleNode : 1;                       		// 0x0220 (0x0004) [0x0000000000000000] [0x00010000] 
	TArray< class AGameCrowdDestination* >             NextDestinations;                                 		// 0x0224 (0x000C) [0x0000000000600001]              ( CPF_Edit | CPF_NeedCtorLink )
	class AGameCrowdDestinationQueuePoint*             QueueHead;                                        		// 0x0230 (0x0004) [0x0000000000200001]              ( CPF_Edit )
	int                                                Capacity;                                         		// 0x0234 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              Frequency;                                        		// 0x0238 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                CustomerCount;                                    		// 0x023C (0x0004) [0x0000000000000000]              
	TArray< class UClass* >                            SupportedAgentClasses;                            		// 0x0240 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< class UObject* >                           SupportedArchetypes;                              		// 0x024C (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< class UClass* >                            RestrictedAgentClasses;                           		// 0x0258 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< class UObject* >                           RestrictedArchetypes;                             		// 0x0264 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	...
	float                                              ExactReachTolerance;                              		// 0x027C (0x0004) [0x0000000000000000]              
	struct FName                                       InteractionTag;                                   		// 0x0280 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	float                                              InteractionDelay;                                 		// 0x0288 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              SpawnRadius;                                      		// 0x028C (0x0004) [0x0000000000000001]              ( CPF_Edit )
...
{
public:
	float                                              Attraction;                                       		// 0x0218 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      bAttractionFalloff : 1;                           		// 0x021C (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
...
{
public:
	float                                              Repulsion;                                        		// 0x0218 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      bAttractionFalloff : 1;                           		// 0x021C (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
...
{
public:
	unsigned long                                      bSpawningActive : 1;                              		// 0x0210 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bEnableCrowdLightEnvironment : 1;                 		// 0x0210 (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned long                                      bCastShadows : 1;                                 		// 0x0210 (0x0004) [0x0000000000000000] [0x00000004] 
	unsigned long                                      bForceObstacleChecking : 1;                       		// 0x0210 (0x0004) [0x0000000000000000] [0x00000008] 
	unsigned long                                      bForceNavMeshPathing : 1;                         		// 0x0210 (0x0004) [0x0000000000000000] [0x00000010] 
	unsigned long                                      bHaveInitialPopulation : 1;                       		// 0x0210 (0x0004) [0x0000000000000000] [0x00000020] 
	unsigned long                                      bWarmupPosition : 1;                              		// 0x0210 (0x0004) [0x0000000000000001] [0x00000040] ( CPF_Edit )
	float                                              SpawnRate;                                        		// 0x0214 (0x0004) [0x0000000000000000]              
	int                                                SpawnNum;                                         		// 0x0218 (0x0004) [0x0000000000000000]              
	float                                              SplitScreenNumReduction;                          		// 0x021C (0x0004) [0x0000000000000000]              
	float                                              Remainder;                                        		// 0x0220 (0x0004) [0x0000000000000000]              
	float                                              AgentFrequencySum;                                		// 0x0224 (0x0004) [0x0000000000000000]              
	TArray< struct FAgentArchetypeInfo >               AgentArchetypes;                                  		// 0x0228 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< class AGameCrowdAgent* >                   AgentPool;                                        		// 0x0234 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	int                                                MaxAgentPoolSize;                                 		// 0x0240 (0x0004) [0x0000000000000000]              
	int                                                AgentCount;                                       		// 0x0244 (0x0004) [0x0000000000000000]              
	struct FLightingChannelContainer                   AgentLightingChannel;                             		// 0x0248 (0x0004) [0x0000000000000000]              
	float                                              AgentWarmupTime;                                  		// 0x024C (0x0004) [0x0000000000000000]              
	float                                              SpawnPrioritizationInterval;                      		// 0x0250 (0x0004) [0x0000000000000000]              
	int                                                PrioritizationIndex;                              		// 0x0254 (0x0004) [0x0000000000000000]              
	int                                                PrioritizationUpdateIndex;                        		// 0x0258 (0x0004) [0x0000000000000000]              
	TArray< class AGameCrowdDestination* >             PrioritizedSpawnPoints;                           		// 0x025C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	float                                              PlayerPositionPredictionTime;                     		// 0x0268 (0x0004) [0x0000000000000000]              
	TArray< class AGameCrowdDestination* >             PotentialSpawnPoints;                             		// 0x026C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	float                                              MaxSpawnDistSq;                                   		// 0x0278 (0x0004) [0x0000000000000000]              
	float                                              MinBehindSpawnDistSq;                             		// 0x027C (0x0004) [0x0000000000000000]              
	int                                                SpawnedCount;                                     		// 0x0280 (0x0004) [0x0000000000000000]              
	int                                                PoolCount;                                        		// 0x0284 (0x0004) [0x0000000000000000]              
	int                                                KilledCount;                                      		// 0x0288 (0x0004) [0x0000000000000000]              
	float                                              HeadVisibilityOffset;                             		// 0x028C (0x0004) [0x0000000000000000]              
	float                                              InitialPopulationPct;                             		// 0x0290 (0x0004) [0x0000000000000000]              
...
public:
	...
	unsigned long                                      bActiveReloadBonusActive : 1;                     		// 0x0210 (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned long                                      bDrawDebug : 1;                                   		// 0x0210 (0x0004) [0x0000000000000000] [0x00000004] 
	...
	float                                              LightFadeTime;                                    		// 0x0218 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	float                                              LightFadeTimeRemaining;                           		// 0x021C (0x0004) [0x0000000000002000]              ( CPF_Transient )
	float                                              LightInitialBrightness;                           		// 0x0220 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	class URadialBlurComponent*                        ExplosionRadialBlur;                              		// 0x0224 (0x0004) [0x0000000004082008]              ( CPF_ExportObject | CPF_Transient | CPF_Component | CPF_EditInline )
	...
	float                                              DirectionalExplosionMinDot;                       		// 0x0250 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	struct FVector                                     ExplosionDirection;                               		// 0x0254 (0x000C) [0x0000000000002020]              ( CPF_Net | CPF_Transient )
...
// 0x003C (0x0978 - 0x093C)
class AMobileHUD : public AGameHUD
{
public:
	unsigned long                                      bForceMobileHUD : 1;                              		// 0x093C (0x0004) [0x0000000000044000] [0x00000001] ( CPF_Config | CPF_GlobalConfig )
	class UTexture2D*                                  ZoneBackgroundOn;                                 		// 0x0940 (0x0004) [0x0000000000000000]              
	class UTexture2D*                                  ZoneBackgroundSmallOn;                            		// 0x0944 (0x0004) [0x0000000000000000]              
	class UTexture2D*                                  ZoneBackgroundTinyOn;                             		// 0x0948 (0x0004) [0x0000000000000000]              
	class UTexture2D*                                  FireZoneBackground;                               		// 0x094C (0x0004) [0x0000000000000000]              
	class UTexture2D*                                  MoveZoneBackground;                               		// 0x0950 (0x0004) [0x0000000000000000]              
	class UTexture2D*                                  SteerZoneBackground;                              		// 0x0954 (0x0004) [0x0000000000000000]              
	struct FColor                                      ZoneTileColor;                                    		// 0x0958 (0x0004) [0x0000000000000000]              
	struct FColor                                      ZoneTextColor;                                    		// 0x095C (0x0004) [0x0000000000000000]              
	class UTexture2D*                                  AnalogHat;                                        		// 0x0960 (0x0004) [0x0000000000000000]              
	TArray< struct FMobileInputZone >                  MobileInputZones;                                 		// 0x0964 (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	int                                                MobileInputConfig;                                		// 0x0970 (0x0004) [0x0000000000000000]              
	int                                                MobileInputConfigMAX;                             		// 0x0974 (0x0004) [0x0000000000000000]              
...
// 0x0010 (0x0614 - 0x0604)
class AGamePlayerController : public APlayerController
{
public:
	unsigned long                                      bWarnCrowdMembers : 1;                            		// 0x0604 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bDebugCrowdAwareness : 1;                         		// 0x0604 (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned long                                      bIsWarmupPaused : 1;                              		// 0x0604 (0x0004) [0x0000000000002000] [0x00000004] ( CPF_Transient )
	float                                              AgentAwareRadius;                                 		// 0x0608 (0x0004) [0x0000000000000000]              
	struct FName                                       CurrentSoundMode;                                 		// 0x060C (0x0008) [0x0000000000002000]              ( CPF_Transient )
...
// 0x0074 (0x0480 - 0x040C)
class AGamePlayerCamera : public ACamera
{
public:
	class UGameCameraBase*                             ThirdPersonCam;                                   		// 0x040C (0x0004) [0x0000000004002001]              ( CPF_Edit | CPF_Transient | CPF_EditInline )
	class UClass*                                      ThirdPersonCameraClass;                           		// 0x0410 (0x0004) [0x0000000000000003]              ( CPF_Edit | CPF_Const )
	class UGameCameraBase*                             FixedCam;                                         		// 0x0414 (0x0004) [0x0000000004002001]              ( CPF_Edit | CPF_Transient | CPF_EditInline )
	class UClass*                                      FixedCameraClass;                                 		// 0x0418 (0x0004) [0x0000000000000003]              ( CPF_Edit | CPF_Const )
	class UGameCameraBase*                             CurrentCamera;                                    		// 0x041C (0x0004) [0x0000000004002001]              ( CPF_Edit | CPF_Transient | CPF_EditInline )
	unsigned long                                      bUseForcedCamFOV : 1;                             		// 0x0420 (0x0004) [0x0000000000002000] [0x00000001] ( CPF_Transient )
	unsigned long                                      bInterpolateCamChanges : 1;                       		// 0x0420 (0x0004) [0x0000000000002000] [0x00000002] ( CPF_Transient )
	unsigned long                                      bResetInterp : 1;                                 		// 0x0420 (0x0004) [0x0000000000002000] [0x00000004] ( CPF_Transient )
	float                                              ForcedCamFOV;                                     		// 0x0424 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	class AActor*                                      LastViewTarget;                                   		// 0x0428 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	float                                              SplitScreenShakeScale;                            		// 0x042C (0x0004) [0x0000000000000003]              ( CPF_Edit | CPF_Const )
	class AActor*                                      LastTargetBase;                                   		// 0x0430 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	unsigned char                                      UnknownData00[ 0xC ];                             		// 0x0434 (0x000C) MISSED OFFSET
...
{
public:
	float                                              MinDecalDistanceSq;                               		// 0x0240 (0x0004) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 33564 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 33754 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 33755 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 33940 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 34319 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 34777 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 34798 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 34808 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 34926 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 35395 ];
