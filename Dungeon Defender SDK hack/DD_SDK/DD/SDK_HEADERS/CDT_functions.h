...
// Function CDT.DunDef_TimedEffect_Harbinger.EndEffects
// [0x00020102] 
// Parameters infos:

void ADunDef_TimedEffect_Harbinger::EndEffects ( )
{
	static UFunction* pFnEndEffects = NULL;

	if ( ! pFnEndEffects )
		pFnEndEffects = (UFunction*) UObject::GObjObjects()->Data[ 77908 ];
...
// Function CDT.DunDef_TimedEffect_Harbinger.TimedEffect
// [0x00020102] 
// Parameters infos:

void ADunDef_TimedEffect_Harbinger::TimedEffect ( )
{
	static UFunction* pFnTimedEffect = NULL;

	if ( ! pFnTimedEffect )
		pFnTimedEffect = (UFunction*) UObject::GObjObjects()->Data[ 77904 ];
...
// Function CDT.DunDef_TimedEffect_Harbinger.Tick
// [0x00020902] ( FUNC_Event )
// Parameters infos:
// float                          DeltaTime                      ( CPF_Parm )

void ADunDef_TimedEffect_Harbinger::eventTick ( float DeltaTime )
{
	static UFunction* pFnTick = NULL;

	if ( ! pFnTick )
		pFnTick = (UFunction*) UObject::GObjObjects()->Data[ 77902 ];
...
// Function CDT.DunDef_TimedEffect_Harbinger.Initialize
// [0x00020102] 
// Parameters infos:
// class UDunDefTimedEffectInterface* Target                         ( CPF_Parm )

void ADunDef_TimedEffect_Harbinger::Initialize ( class UDunDefTimedEffectInterface* Target )
{
	static UFunction* pFnInitialize = NULL;

	if ( ! pFnInitialize )
		pFnInitialize = (UFunction*) UObject::GObjObjects()->Data[ 77899 ];
...
void ADunDefHarbinger::eventFireAttackShootRight ( )
{
	...
	if ( ! pFnFireAttackShootRight )
		pFnFireAttackShootRight = (UFunction*) UObject::GObjObjects()->Data[ 77955 ];
...
void ADunDefHarbinger::eventFireAttackShootLeft ( )
{
	...
	if ( ! pFnFireAttackShootLeft )
		pFnFireAttackShootLeft = (UFunction*) UObject::GObjObjects()->Data[ 77953 ];
...
void ADunDefHarbinger::eventFireAttackBegin ( )
{
	...
	if ( ! pFnFireAttackBegin )
		pFnFireAttackBegin = (UFunction*) UObject::GObjObjects()->Data[ 77952 ];
...
void ADunDefHarbinger::eventPostBeginPlay ( )
{
	...
	if ( ! pFnPostBeginPlay )
		pFnPostBeginPlay = (UFunction*) UObject::GObjObjects()->Data[ 77951 ];
...
void ADunDefHarbinger::GetProjectileSpawnTransformation ( struct FName socketToUse, struct FVector* Position, struct FRotator* Orientation )
{
	...
	if ( ! pFnGetProjectileSpawnTransformation )
		pFnGetProjectileSpawnTransformation = (UFunction*) UObject::GObjObjects()->Data[ 77947 ];
...
bool ADunDefHarbinger::IsCurrentlyPlayingAttackAnimation ( )
{
	...
	if ( ! pFnIsCurrentlyPlayingAttackAnimation )
		pFnIsCurrentlyPlayingAttackAnimation = (UFunction*) UObject::GObjObjects()->Data[ 77945 ];
...
float ADunDefHarbinger::PlayShootFireAnimation ( )
{
	...
	if ( ! pFnPlayShootFireAnimation )
		pFnPlayShootFireAnimation = (UFunction*) UObject::GObjObjects()->Data[ 77943 ];
...
bool ADunDefHarbinger::IsCurrentlyPlayingChargeAnimation ( )
{
	...
	if ( ! pFnIsCurrentlyPlayingChargeAnimation )
		pFnIsCurrentlyPlayingChargeAnimation = (UFunction*) UObject::GObjObjects()->Data[ 77941 ];
...
float ADunDefHarbinger::PlayChargeFireAnimation ( )
{
	...
	if ( ! pFnPlayChargeFireAnimation )
		pFnPlayChargeFireAnimation = (UFunction*) UObject::GObjObjects()->Data[ 77939 ];
...
void ADunDefHarbinger::PlayHurtAnimation ( class UClass* DamageType, struct FVector HitLocation )
{
	...
	if ( ! pFnPlayHurtAnimation )
		pFnPlayHurtAnimation = (UFunction*) UObject::GObjObjects()->Data[ 77936 ];
...
void ADunDefHarbinger::PlayJumpAnimation ( )
{
	...
	if ( ! pFnPlayJumpAnimation )
		pFnPlayJumpAnimation = (UFunction*) UObject::GObjObjects()->Data[ 77935 ];
...
void ADunDefHarbinger::ExecReplicatedFunction ( struct FName FunctionName, struct FName nameParam1, struct FName nameParam2, class AActor* actorParam1, class AActor* actorParam2, struct FVector vecParam1, struct FRotator rotParam1, float floatParam1, float floatParam2, float floatParam3, float floatParam4, unsigned long boolParam1, unsigned long boolParam2, unsigned long boolParam3, struct FString stringParam1, class UObject* objectParam1 )
{
	...
	if ( ! pFnExecReplicatedFunction )
		pFnExecReplicatedFunction = (UFunction*) UObject::GObjObjects()->Data[ 77918 ];
...
void ADunDefHarbingerController::PawnDied ( class APawn* inPawn )
{
	...
	if ( ! pFnPawnDied )
		pFnPawnDied = (UFunction*) UObject::GObjObjects()->Data[ 77994 ];
...
void ADunDefHarbingerController::CheckPlayer ( class ADunDefPlayer* aPlayer )
{
	...
	if ( ! pFnCheckPlayer )
		pFnCheckPlayer = (UFunction*) UObject::GObjObjects()->Data[ 77990 ];
...
void ADunDefHarbingerController::CheckForNearbyPlayers ( )
{
	...
	if ( ! pFnCheckForNearbyPlayers )
		pFnCheckForNearbyPlayers = (UFunction*) UObject::GObjObjects()->Data[ 77988 ];
...
void ADunDefHarbingerController::ObstructionJump ( struct FVector jumpForwardDir, struct FVector jumpSideDir )
{
	...
	if ( ! pFnObstructionJump )
		pFnObstructionJump = (UFunction*) UObject::GObjObjects()->Data[ 77985 ];
...
void ADunDefHarbingerController::NotifyTakeHitEX ( class AController* InstigatedBy, struct FVector HitLocation, int Damage, class UClass* DamageType, struct FVector Momentum, class AActor* DamageCauser )
{
	...
	if ( ! pFnNotifyTakeHitEX )
		pFnNotifyTakeHitEX = (UFunction*) UObject::GObjObjects()->Data[ 77971 ];
...
void ADunDefHarbingerController::eventPostBeginPlay ( )
{
	...
	if ( ! pFnPostBeginPlay )
		pFnPostBeginPlay = (UFunction*) UObject::GObjObjects()->Data[ 77970 ];
...
void ADunDefHarbingerController::FireProjectiles ( struct FName socketToUse )
{
	...
	if ( ! pFnFireProjectiles )
		pFnFireProjectiles = (UFunction*) UObject::GObjObjects()->Data[ 77968 ];
