...
public:
	...
	// Virtual Functions
	virtual void VirtualFunction00 ( );																			// 0x010B2CE0 (0x00)
	virtual void VirtualFunction01 ( );																			// 0x00C54C80 (0x04)
	virtual void VirtualFunction02 ( );																			// 0x00C53F20 (0x08)
	virtual void VirtualFunction03 ( );																			// 0x01242A90 (0x0C)
	virtual void VirtualFunction04 ( );																			// 0x013F8810 (0x10)
	virtual void VirtualFunction05 ( );																			// 0x01052C90 (0x14)
	virtual void VirtualFunction06 ( );																			// 0x00CA72D0 (0x18)
	virtual void VirtualFunction07 ( );																			// 0x00CA7320 (0x1C)
	virtual void VirtualFunction08 ( );																			// 0x00C46A10 (0x20)
	virtual void VirtualFunction09 ( );																			// 0x00CA6BC0 (0x24)
	virtual void VirtualFunction10 ( );																			// 0x010B2CE0 (0x28)
	virtual void VirtualFunction11 ( );																			// 0x00CA5D70 (0x2C)
	virtual void VirtualFunction12 ( );																			// 0x00C4D320 (0x30)
	virtual void VirtualFunction13 ( );																			// 0x00C58490 (0x34)
	virtual void VirtualFunction14 ( );																			// 0x00CA53F0 (0x38)
	virtual void VirtualFunction15 ( );																			// 0x00C31930 (0x3C)
	virtual void VirtualFunction16 ( );																			// 0x01052C90 (0x40)
	virtual void VirtualFunction17 ( );																			// 0x00CA6690 (0x44)
	virtual void VirtualFunction18 ( );																			// 0x00CA5170 (0x48)
	virtual void VirtualFunction19 ( );																			// 0x00CA6770 (0x4C)
	virtual void VirtualFunction20 ( );																			// 0x00CA5180 (0x50)
	virtual void VirtualFunction21 ( );																			// 0x00CA5360 (0x54)
	virtual void VirtualFunction22 ( );																			// 0x00CA51C0 (0x58)
	virtual void VirtualFunction23 ( );																			// 0x00CA51B0 (0x5C)
	virtual void VirtualFunction24 ( );																			// 0x01052C90 (0x60)
	virtual void VirtualFunction25 ( );																			// 0x01052C90 (0x64)
	virtual void VirtualFunction26 ( );																			// 0x00CA51A0 (0x68)
	virtual void VirtualFunction27 ( );																			// 0x00CA51C0 (0x6C)
	virtual void VirtualFunction28 ( );																			// 0x00CA51B0 (0x70)
	virtual void VirtualFunction29 ( );																			// 0x00CA51C0 (0x74)
	virtual void VirtualFunction30 ( );																			// 0x00CA51B0 (0x78)
	virtual void VirtualFunction31 ( );																			// 0x00CA7AC0 (0x7C)
	virtual void VirtualFunction32 ( );																			// 0x00CA6840 (0x80)
	virtual void VirtualFunction33 ( );																			// 0x00CA6A00 (0x84)
	virtual void VirtualFunction34 ( );																			// 0x01052C90 (0x88)
	virtual void VirtualFunction35 ( );																			// 0x00C497A0 (0x8C)
	virtual void VirtualFunction36 ( );																			// 0x00CB25B0 (0x90)
	virtual void VirtualFunction37 ( );																			// 0x00C16F10 (0x94)
	virtual void VirtualFunction38 ( );																			// 0x00C16F40 (0x98)
	virtual void VirtualFunction39 ( );																			// 0x00C16F70 (0x9C)
	virtual void VirtualFunction40 ( );																			// 0x00C18460 (0xA0)
	virtual void VirtualFunction41 ( );																			// 0x0120C410 (0xA4)
	virtual void VirtualFunction42 ( );																			// 0x014AEDD0 (0xA8)
	virtual void VirtualFunction43 ( );																			// 0x014AEDD0 (0xAC)
	virtual void VirtualFunction44 ( );																			// 0x01052C90 (0xB0)
	virtual void VirtualFunction45 ( );																			// 0x01061BB0 (0xB4)
	virtual void VirtualFunction46 ( );																			// 0x0106C160 (0xB8)
	virtual void VirtualFunction47 ( );																			// 0x00CB4980 (0xBC)
	virtual void VirtualFunction48 ( );																			// 0x00C4EDF0 (0xC0)
	virtual void VirtualFunction49 ( );																			// 0x013F8810 (0xC4)
	virtual void VirtualFunction50 ( );																			// 0x013F8810 (0xC8)
	virtual void VirtualFunction51 ( );																			// 0x00C467A0 (0xCC)
	virtual void VirtualFunction52 ( );																			// 0x00C53BF0 (0xD0)
	virtual void VirtualFunction53 ( );																			// 0x00CA7960 (0xD4)
	virtual void VirtualFunction54 ( );																			// 0x00E273C0 (0xD8)
	virtual void VirtualFunction55 ( );																			// 0x00CA5340 (0xDC)
	virtual void VirtualFunction56 ( );																			// 0x00C2F910 (0xE0)
	virtual void VirtualFunction57 ( );																			// 0x00CB1D10 (0xE4)
	virtual void VirtualFunction58 ( );																			// 0x01052C90 (0xE8)
	virtual void VirtualFunction59 ( );																			// 0x0120C410 (0xEC)
	virtual void VirtualFunction60 ( );																			// 0x00C13FE0 (0xF0)
	virtual void VirtualFunction61 ( );																			// 0x00C14000 (0xF4)
	virtual void VirtualFunction62 ( );																			// 0x00CB5190 (0xF8)
	virtual void VirtualFunction63 ( );																			// 0x00CA51D0 (0xFC)
	virtual void VirtualFunction64 ( );																			// 0x00C517E0 (0x100)
	virtual void ProcessEvent ( class UFunction* pFunction, void* pParms, void* pResult = NULL );				// 0x00C70BB0 (0x104)
};
