...
// 0x009C (0x03F8 - 0x035C)
class ADunDefWebProjectile : public ADunDefHomingProjectile
{
public:
	class AActor*                                      AttachedTo;                                       		// 0x035C (0x0004) [0x0000000000000020]              ( CPF_Net )
	TArray< struct FWebbedActor >                      AffectingActors;                                  		// 0x0360 (0x000C) [0x0000000000480000]              ( CPF_Component | CPF_NeedCtorLink )
	float                                              MovementSpeedMultiplier;                          		// 0x036C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              TowerAttackRateMultiplier;                        		// 0x0370 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              PlayerAttackRateMultiplier;                       		// 0x0374 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              pawnDamageModifier;                               		// 0x0378 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              PawnAttackSpeedMult;                              		// 0x037C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              BaseStatusAffectTime;                             		// 0x0380 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              BasePawnStatusAffectTime;                         		// 0x0384 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class UParticleSystemComponent*                    AttachedVFX;                                      		// 0x0388 (0x0004) [0x0000000004080009]              ( CPF_Edit | CPF_ExportObject | CPF_Component | CPF_EditInline )
	class UParticleSystem*                             WebAttachTemplate;                                		// 0x038C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              AttachedVFXScale;                                 		// 0x0390 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FVector                                     AttachedVFXTranslation;                           		// 0x0394 (0x000C) [0x0000000000000001]              ( CPF_Edit )
	float                                              DefaultBoundsHeight;                              		// 0x03A0 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              DefaultBoundWidth;                                		// 0x03A4 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              WebbedJumpZ;                                      		// 0x03A8 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FName                                       PlayerAttachSocketName;                           		// 0x03AC (0x0008) [0x0000000000000001]              ( CPF_Edit )
	TArray< class UClass* >                            IgnoreActorsForWeb;                               		// 0x03B4 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	class UParticleSystem*                             WebbedEffect;                                     		// 0x03C0 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              WebbedEffectScale;                                		// 0x03C4 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      bUseOriginalHoming : 1;                           		// 0x03C8 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned long                                      bUseEnemyPawnDeboosting : 1;                      		// 0x03C8 (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned long                                      bHasAttached : 1;                                 		// 0x03C8 (0x0004) [0x0000000000000020] [0x00000004] ( CPF_Net )
	unsigned long                                      bIsHoming : 1;                                    		// 0x03C8 (0x0004) [0x0000000000000000] [0x00000008] 
	unsigned long                                      bTempHitPawn : 1;                                 		// 0x03C8 (0x0004) [0x0000000000002000] [0x00000010] ( CPF_Transient )
	unsigned long                                      bShutDown : 1;                                    		// 0x03C8 (0x0004) [0x0000000000000020] [0x00000020] ( CPF_Net )
	unsigned long                                      bScaleUp : 1;                                     		// 0x03C8 (0x0004) [0x0000000000000020] [0x00000040] ( CPF_Net )
	TArray< class UTowerDeboosterObject* >             TowerDeBoosters;                                  		// 0x03CC (0x000C) [0x0000000004400001]              ( CPF_Edit | CPF_NeedCtorLink | CPF_EditInline )
	TArray< unsigned char >                            deboostingTypes;                                  		// 0x03D8 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	unsigned char                                      towerBoostType;                                   		// 0x03E4 (0x0001) [0x0000000000000000]              
	struct FVector                                     InitialTargetLocation;                            		// 0x03E8 (0x000C) [0x0000000000000000]              
	float                                              ScaleTime;                                        		// 0x03F4 (0x0004) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 78180 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 84624 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 89421 ];
...
{
public:
	int                                                PortalHitsRemaining;                              		// 0x06E8 (0x0004) [0x0000000000000020]              ( CPF_Net )
	int                                                AllowedPortalHits;                                		// 0x06EC (0x0004) [0x0000000000000020]              ( CPF_Net )
	struct FColor                                      TextColor;                                        		// 0x06F0 (0x0004) [0x0000000000000000]              
	struct FColor                                      InvincibleTextColor;                              		// 0x06F4 (0x0004) [0x0000000000000000]              
	struct FString                                     HUDRemainingTouchesString;                        		// 0x06F8 (0x000C) [0x0000000000400020]              ( CPF_Net | CPF_NeedCtorLink )
	unsigned long                                      bIsCoreInvincible : 1;                            		// 0x0704 (0x0004) [0x0000000000000020] [0x00000001] ( CPF_Net )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 89449 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 89512 ];
...
{
public:
	int                                                currentPortal;                                    		// 0x0538 (0x0004) [0x0000000000000000]              
	float                                              GameEnemyHealthMultiplier;                        		// 0x053C (0x0004) [0x0000000000000000]              
	float                                              GameEnemyDamageMultiplier;                        		// 0x0540 (0x0004) [0x0000000000000000]              
	float                                              GameEnemyScaleMultiplier;                         		// 0x0544 (0x0004) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 89521 ];
...
{
public:
	struct FString                                     PairWasMatched;                                   		// 0x06E8 (0x000C) [0x0000000000408000]              ( CPF_Localized | CPF_NeedCtorLink )
	struct FString                                     BoySpawned;                                       		// 0x06F4 (0x000C) [0x0000000000408000]              ( CPF_Localized | CPF_NeedCtorLink )
	struct FString                                     GirlSpawned;                                      		// 0x0700 (0x000C) [0x0000000000408000]              ( CPF_Localized | CPF_NeedCtorLink )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 89529 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 89663 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 89695 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 89837 ];
...
// 0x0024 (0x055C - 0x0538)
class AGameInfo_VDay : public AMain
{
public:
	TArray< class ADunDefEnemy* >                      Boys;                                             		// 0x0538 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< class ADunDefEnemy* >                      Girls;                                            		// 0x0544 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	unsigned long                                      bUsingGenderSpawnTimer : 1;                       		// 0x0550 (0x0004) [0x0000000000000000] [0x00000001] 
	float                                              GenderSpawnTimer;                                 		// 0x0554 (0x0004) [0x0000000000000000]              
	class UUI_KillCount*                               myKillCountUI;                                    		// 0x0558 (0x0004) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 90280 ];
