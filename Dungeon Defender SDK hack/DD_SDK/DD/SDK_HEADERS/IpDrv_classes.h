...
public:
	...
	class UClass*                                      AcceptClass;                                      		// 0x0234 (0x0004) [0x0000000000000000]              
	TArray< unsigned char >                            SendFIFO;                                         		// 0x0238 (0x000C) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
	struct FString                                     RecvBuf;                                          		// 0x0244 (0x000C) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
...
// 0x014C (0x039C - 0x0250)
class AWebServer : public ATcpLink
{
public:
	struct FString                                     ServerName;                                       		// 0x0250 (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FString                                     Applications[ 0xA ];                              		// 0x025C (0x0078) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FString                                     ApplicationPaths[ 0xA ];                          		// 0x02D4 (0x0078) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	unsigned long                                      bEnabled : 1;                                     		// 0x034C (0x0004) [0x0000000000004000] [0x00000001] ( CPF_Config )
	int                                                ListenPort;                                       		// 0x0350 (0x0004) [0x0000000000004000]              ( CPF_Config )
	int                                                MaxConnections;                                   		// 0x0354 (0x0004) [0x0000000000004000]              ( CPF_Config )
	int                                                DefaultApplication;                               		// 0x0358 (0x0004) [0x0000000000004000]              ( CPF_Config )
	int                                                ExpirationSeconds;                                		// 0x035C (0x0004) [0x0000000000004000]              ( CPF_Config )
	struct FString                                     ServerURL;                                        		// 0x0360 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class UWebApplication*                             ApplicationObjects[ 0xA ];                        		// 0x036C (0x0028) [0x0000000000000000]              
	int                                                ConnectionCount;                                  		// 0x0394 (0x0004) [0x0000000000000000]              
	int                                                ConnId;                                           		// 0x0398 (0x0004) [0x0000000000000000]              
...
{
public:
	class AWebServer*                                  WebServer;                                        		// 0x0250 (0x0004) [0x0000000000000000]              
	struct FString                                     ReceivedData;                                     		// 0x0254 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class UWebRequest*                                 Request;                                          		// 0x0260 (0x0004) [0x0000000000000000]              
	class UWebResponse*                                Response;                                         		// 0x0264 (0x0004) [0x0000000000000000]              
	class UWebApplication*                             Application;                                      		// 0x0268 (0x0004) [0x0000000000000000]              
	unsigned long                                      bDelayCleanup : 1;                                		// 0x026C (0x0004) [0x0000000000000000] [0x00000001] 
	int                                                RawBytesExpecting;                                		// 0x0270 (0x0004) [0x0000000000000000]              
	int                                                MaxValueLength;                                   		// 0x0274 (0x0004) [0x0000000000004000]              ( CPF_Config )
	int                                                MaxLineLength;                                    		// 0x0278 (0x0004) [0x0000000000004000]              ( CPF_Config )
	int                                                ConnId;                                           		// 0x027C (0x0004) [0x0000000000000000]              
