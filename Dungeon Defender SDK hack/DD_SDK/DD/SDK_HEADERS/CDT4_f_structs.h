...
{
	struct FEquipmentNetInfo                           Info;                                             		// 0x0000 (0x00F8) [0x0000000000400080]              ( CPF_Parm | CPF_NeedCtorLink )
	class UObject*                                     fromDroppedEquipment;                             		// 0x00F8 (0x0004) [0x0000000000000090]              ( CPF_OptionalParm | CPF_Parm )
};
